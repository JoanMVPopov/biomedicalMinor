...
def do_runs(runs_range, folder_names, current_file_directory, params, do_plots=False,
    ...
    """
    Main method that goes through the selected range of runs
    :param runs_range: range of runs, expected to be a range object
    :param folder_names: -
    :param current_file_directory: -
    :param params: current parameter combination
    :param do_plots: Boolean that determines wheteher we will do the volume progression plots
    :param show_3d_model: Boolean that determines if we will show the 3D model for each run
    :param show_focus_contours: Boolean that determines if we will show the high-pass contours, usually for debugging
    :return:
    """
